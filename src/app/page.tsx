      ...
      <div className="grid lg:grid-cols-[1fr_5fr] md:grid-cols-[2fr_5fr] sm:grid-cols-[3fr_5fr] gap-0">
        ...
        <div className="flex flex-col items-center justify-center p-4">
          ...
          <Link href="/professional-summary">
            <button className="bg-yellow-600 hover:bg-gray-500 transition-all duration-500 text-gray-100 hover:text-white uppercase font-bold py-3 px-8 mt-8">Professional Summary</button>
          </Link>
        </div>
      </div>
    </main>
